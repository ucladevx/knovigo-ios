...
var markerCoords = [
    ...
    location(name: "Janss Steps", coordinates: CLLocationCoordinate2D(latitude: 34.072191, longitude: -118.4426622), address: "Los Angeles, CA 90095", image: UIImage(named: "tongva.jpg")!, wideImage: UIImage(named: "tongvaWide.jpg")!, distance: 2.6, isOpen: true, label: "UCLA", pinLabel: 0.10, sliderMask: 0.3, sliderDistance: 1, sliderDensity: 0.4),
